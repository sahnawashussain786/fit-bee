  ...
  return (
    <div className="min-h-screen flex bg-deep-bg">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 relative">
        {/* Background Glow */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-neon-purple/10 rounded-full blur-[100px] pointer-events-none"></div>
          ...
          <SignUp
            appearance={{
              elements: {
                ...
                formFieldInput:
                  "bg-deep-bg border-white/10 text-white focus:border-neon-purple",
                footerActionLink: "text-neon-purple hover:text-neon-blue",
                formButtonPrimary:
                  "bg-neon-purple hover:bg-neon-blue text-white",
              },
            }}
            path="/sign-up"
          />
